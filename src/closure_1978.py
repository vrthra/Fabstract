...
def my_predicate(src):
    with tempfile.NamedTemporaryFile(prefix='closure') as tmp:
        ...
        tmp.flush()
        o = A.do('java -jar lang/js/compilers/closure-compiler-v20151216.jar -O ADVANCED'.split(' ') + [tmp.   name])
...
if __name__ == '__main__':
    I.main('./lang/js/grammar/javascript.fbjson', './lang/js/bugs/closure.1978.js', my_predicate, max_checks=100)
